 ...
 * </p>
 * <ul>
 *   <li>{@link mdcms.impl.ConfigurationImpl#getBase_Artifact <em>Base Artifact</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigurationImpl extends MinimalEObjectImpl.Container implements Configuration {
	...
	protected EClass eStaticClass() {
		return MdcmsPackage.Literals.CONFIGURATION;
	}
		...
		if (base_Artifact != null && base_Artifact.eIsProxy()) {
			...
			if (base_Artifact != oldBase_Artifact) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MdcmsPackage.CONFIGURATION__BASE_ARTIFACT, oldBase_Artifact, base_Artifact));
			}
		}
	...
	public void setBase_Artifact(Artifact newBase_Artifact) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MdcmsPackage.CONFIGURATION__BASE_ARTIFACT, oldBase_Artifact, base_Artifact));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MdcmsPackage.CONFIGURATION__BASE_ARTIFACT:
